...
const BloodFind = () => {
    ...
    const districts = [
      ...
      "Dolpa", "Doti", "Gorkha", "Gulmi", "Humla", "Ilam", "Jajarkot", "Jhapa",
      ...
      "Nawalparasi (Bardaghat Susta East)", "Nawalparasi (Bardaghat Susta West)",
            ...
            >
             <div className="text-4xl font-extrabold text-red-600 mb-4">
              {result.bloodType}
                ...
                <button onClick={() => navigate("/contactuser",{ state: { user: result } })}

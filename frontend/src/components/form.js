 ...
 "Mugu","Mustang","Myagdi", "Nawalparasi (Bardaghat Susta East)",  "Nawalparasi (Bardaghat Susta West)",  "Nuwakot","Okhaldhunga",
  ...
  const handleSubmit = (e) => {
    ...
    const sendFormData = async () => {
      const res = await setFormData(
        requesterData.fullname.toString(),
        requesterData.contactnumber.toString(),
        requesterData.email.toString(),
        requesterData.tag.toString(),
        requesterData.bloodType.toString(),
        requesterData.age.toString(),
        requesterData.weight.toString(),
        requesterData.gender.toString(),
        requesterData.address.toString()
      );
      if (res.status === 400) {
  ...
  return (
    <div className="bg-slate-200">
      <div className="mx-auto max-w-3xl text-black p-5 border rounded-2xl shadow-2xl bg-white">
        <h2 className="text-3xl text-red-600 border-b-4 border-gray-300 font-bold mb-10 text-center">
          Blood Request Form
        </h2>
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <select
              name="tag"
              value={requesterData.tag}
              onChange={(e) =>
                setRequesterData({ ...requesterData, tag: e.target.value })
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setRequesterData({ ...requesterData, fullname: e.target.value })
              }
          ...
          <div
            value={requesterData.gender}
            onChange={(e) =>
              setRequesterData({ ...requesterData, gender: e.target.value })
            }
          >
          ...
          <div>
            ...
            max="55"
              ...
              value={requesterData.age}
              onChange={(e) =>
                setRequesterData({ ...requesterData, age: e.target.value })
              }
              className="w-full border rounded p-2"
            />
          </div>
          <div>
            ...
            <input
              ...
              max="100"
              placeholder=" 45 kg"
              value={requesterData.weight}
              onChange={(e) =>
                setRequesterData({ ...requesterData, weight: e.target.value })
              }
              className="w-full border rounded p-2"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              name="email"
              onChange={(e) =>
                setRequesterData({ ...requesterData, email: e.target.value })
              }
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setRequesterData({ ...requesterData, address: e.target.value })
              }
              className="w-full border rounded p-2"
            >
